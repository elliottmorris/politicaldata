...
I've written a detailed guide on using R for analyzing political data, [_A Guide to Analyzing (American) Political Data in R_](https://www.thecrosstab.com/project/guide), that uses many of the functions and datasets from this package. If you want use cases that extend beyond the examples in the function documentation, this is a good place to start.
